var packageExplorerController = (function() {
	...
	let controllerConfig = {
		projectIcon: 	"scripts/PackageExplorer/images/field.png",
		packageIcon: 	"scripts/PackageExplorer/images/method.png",
		typeIcon: 		"scripts/PackageExplorer/images/package.png",
    ...
    function prepareTreeView() {
		...
		items.sort(
			function(a,b) {
				...
				var sortA =  parseInt(a.nodeID, 10);
				var sortB =  parseInt(b.nodeID, 10);
