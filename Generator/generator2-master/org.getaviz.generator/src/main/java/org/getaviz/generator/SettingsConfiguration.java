...
//Orginal:
	...
	public boolean isSkipScan() {
		return config.getBoolean("input.skip_scan", true);
	}
	
	public String getInputFiles() { // Überspringt getInputFiles, wegen nem Fehler den ich nicht resolven konnte
		if (isSkipScan()) {	
        return "abc"; // or return a default value if needed
    	} else {
		return "cde";
		}
	}
	...
	public Metaphor getMetaphor() {
		String metaphor = config.getString("metaphor", "city");
